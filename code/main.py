...
TRAINING_FILE_PATH = '../Data/train.txt' #put train file path
MODEL_PATH = 'rw.model'
WORD_VECTORS_PATH = 'word_vectors'
WORD_VECTOR_MATRIX = "rw3"
...
def create_and_save_model():
    ...
    #                 seed=99)
    model = Word2Vec(alpha=0.03, workers=3, window=3, sg=1, hs=1,
